List TESTPAPERONE = [
  ...
  },
  {
    ...
    "option": [
      {
        "optionName": "地面装置没有保护围栏或者粗壮的树将装置与路隔离",
        "optionScore": 0,
        "optionCode": 1,
      },
      {
        "optionName": "地面装置有保护围栏或者粗壮的树将装置与路隔离",
        "optionScore": 2,
        "optionCode": 2,
      },
      {
  ...
  },
  {
    ...
    "option": [
      {
        "optionName": "地面装置与道路之间没有≥1.2m深沟渠 ",
        "optionScore": 0,
        "optionCode": 1,
      },
      {
        "optionName": "地面装置与道路之间有≥1.2m深沟渠",
        "optionScore": 2,
        "optionCode": 2,
      },
      {
  ...
  },
  {
    ...
    "option": [
      {
        "optionName": "地面装置无警示标志符号",
        "optionScore": 0,
        "optionCode": 1,
      },
      {
        "optionName": "地面装置有警示标志符号",
        "optionScore": 1,
        "optionCode": 2,
      },
      {
  ...
  },
  {
    ...
    "option": [
      {
        "optionName": "占压现象严重（5处以上）≥5",
        "optionScore": 0,
        "optionCode": 1,
      },
      {
        "optionName": "存在占压（1～4处）",
        "optionScore": 3,
        "optionCode": 2,
      },
      {
